...
def distance(habitat_1, habitat_2):
    ...
    '''
    return sqrt((habitat_1['vegetation'] - habitat_2['vegetation'])**2 + (habitat_1['proximite_eau'] - habitat_2['proximite_eau'])**2 +
                (habitat_1['densite_urbaine'] - habitat_2['densite_urbaine'])**2 + (habitat_1['disponibilite_proies'] - habitat_2['disponibilite_proies'])**2)
...
def distance_d_un_habitat(habitat, habitats):
    ...
    '''
    res = []
    for elem in habitats :
        res.append((distance(habitat, elem), elem))
    return res
...
print(k_plus_proches(30, nouveau, zones_connues))
print(presence_renard(30, nouveau, zones_connues))
